...
public class Skill {
    ...
    //Verifier la fonction getprofile créé par Christoph dans CharacterWarhammer
    public int computeSkillValue(){
        int temp = 10;
        //Verifier la formule de calcul :
        return getprofile("Ag")*(1+0.1*mLevel) + mBonus;
    }
    ...
    public Skill(String Name, Char Charact, int Level, int Bonus) {
