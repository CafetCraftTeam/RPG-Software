...
public class CharacterSkillFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mGroups = new String[]{"Test Header 1", "Test Header 2", "Test Header 3", "Test Header 4"};

        mChildren = new String[][]{
                {"s simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.", "blabla"},
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mRootView = inflater.inflate(R.layout.fragment_character_skill, container, false);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mListView = (ExpandableListView) view.findViewById(R.id.expListView);
        mListView.setAdapter(new ExpandableListAdapter(getActivity(), mGroups, mChildren));
